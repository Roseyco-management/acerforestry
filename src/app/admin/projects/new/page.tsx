      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="mt-2 text-slate-600">
            Create a new woodland creation or maintenance project
          </p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg border border-slate-200 p-6">
          ...
          <FormGroup>
            ...
            <TextInput
              ...
              placeholder="e.g., Oak Woodland Creation Phase 1"
              required
            />
            <TextInput
              label="Location"
              ...
              placeholder="e.g., County Wicklow"
              required
            />
        ...
        <div className="bg-white rounded-lg border border-slate-200 p-6">
          ...
          <FormGroup>
            ...
            <TextInput
              ...
              onChange={handleChange}
              placeholder="e.g., Woodland Creation Scheme"
            />
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <TextInput
                label="Total Cost (£)"
